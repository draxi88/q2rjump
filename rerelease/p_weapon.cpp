...
bool Pickup_Weapon(edict_t *ent, edict_t *other)
{
	...
	//q2rjump
	if (other->client->jump_started && !other->client->jump_finished) {
		other->client->jump_finished = true;
		other->client->jump_timer = level.time.seconds() - other->client->jump_timer_start;
	}
	return false;
